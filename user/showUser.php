        ...
        <div class="row">
           <!-- <div class="col-md-1"></div>  -->
            <div class="col-md-12" style="margin-top:4%">
                <h1>Users   <a href="../profile/adminProfile.php" Style="color:black">Home</a></h1>
                            ...
                            while($row = $result->fetch_assoc()) {
                               ...
                               echo '
                                    <tr>
                                      ...
                                      <td>
                                        <a href="#" class="btn btn-primary " role="button" aria-pressed="true" onclick="editAddress('.$row["user_id"].')" >Edit</a>
                                      
                                        
                                        
                                        <button type="button" name="deleteData" class="btn btn-
                                        danger active" onclick="deleteAddress('.$row['user_id'].')">Delete</button>
                                      </td>
                                    </tr>
                                ';
                                $a++;
