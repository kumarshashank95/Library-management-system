        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top:4%">
              ...
              <div class="card-header" style="background-color:white;" >
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="../bookCategory/addBookCategory.php">Add Category</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link active" href="../bookCategory/showBookCategory.php">Edit Book Categories</a>
                    </li>
                      <div class="col-md-7">
                           <table class="table">
                            <thead>
