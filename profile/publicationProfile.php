  ...
  <head>
    ...
    <script>
        function editAddress(id){
                ...
                location.href="editPublication.php?id="+id;       
        }
        function deleteAddress(id){
            
                location.href="deletePublication.php?id="+id;       
        }
    </script>
  </head>
  <body>
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top:4%">
              ...
              <div class="card-header" style="background-color:white;" >
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="../publication/addPublication.php">Add Publication</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link active" href="../publication/showPublication.php">Edit Book Publication</a>
                    </li>
                      <div class="col-md-7">
                          <table class="table">
                        <thead>
