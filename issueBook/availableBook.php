  ...
  <head>
    ...
    <script>
        function editAddress(id){
                ...
                location.href="issueBook.php?id="+id;       
        }
        ...
        <div class="row">
           <!-- <div class="col-md-1"></div>  -->
            <div class="col-md-12" style="margin-top:4%">
                <h1>Available Books <a href="../profile/userProfile.php" style="color:black;">Home</a></h1>
                <hr>
                <br>
                <table class="table">
                  <thead>
                            ...
                            while($row = $result->fetch_assoc()) {
                               ...
                               echo '
                                    <tr>
                                      ...
                                      <td>
                                        <a href="#" class="btn btn-primary " role="button" aria-pressed="true" onclick="editAddress('.$row["book_id"].')" >Issue</a>
