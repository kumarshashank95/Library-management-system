...
if(isset($_SESSION['admin_id']) and isset($_SESSION['admin_address_id']))
{
        ...
        if(isset($_POST['submit']))
    {
        ...
        $publication=$_POST['PublicationData'];
        //echo $publication;

        if(!empty($publication)){
             $sql="INSERT INTO publication (publication_name) VALUES('$publication');";
           if ($conn->query($sql) === TRUE) {
                //$msg="New record created successfully";
                header('Location: addPublication.php');
                exit;
            } else {
            ...
            <div class="col-md-6" style="background-color:ed;margin-top:4%">
                            ...
                            <form action="addPublication.php" method="post">
                                <div class="form-group">
                                    <label for="PublicationLabel">Publicaton</label>
                                    <input type="text" class="form-control" id="PublicatonLabel"  placeholder="Publicaton" required name="PublicationData">
                                </div>
