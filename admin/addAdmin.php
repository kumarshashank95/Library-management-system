...
//inserting data in admin table having foregin key address_id
                    if(!empty ($data_fname) and !empty($data_lname) and !empty($data_email) and
                        !empty ($data_phone) and !empty($data_date) and !empty($shuffled))
                    {
                            $sql="INSERT INTO admin (admin_fname,admin_lname,admin_email,admin_dob,admin_phone,admin_address_id,admin_password) VALUES('$data_fname','$data_lname','$data_email','$data_date',$data_phone,$address_id,'$shuffled');";
                                    if($conn->query($sql))
                                    {
      ...
      <div class="container">
          <div class="row">
            ...
            <div class="col-md-10" style="background-color:ed;margin-top:4%">
                <h2>Add Admin  <a style="color:black" href="showAdmin.php">Available Admin</a></h2>
                <hr>
                <br>
                <form action="addAdmin.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" maxlength="13" class="form-control" id="phoneLabel"  placeholder="Phone Number"  name="PhoneData" required>
                    </div>
                <div class="form-group">
