  ...
  <head>
    ...
    <script>
        function editAddress(id){
                ...
                location.href="editBookCategory.php?id="+id;       
        }
        function deleteAddress(id){
            
                location.href="deleteBookCategory.php?id="+id;       
        }
    </script>
  </head>
  <body>
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo '
                                    <tr>
                                      ...
                                      <td>
                                        <a href="#" class="btn btn-primary " role="button" aria-pressed="true" onclick="editAddress('.$row["category_id"].')" >Edit</a>
